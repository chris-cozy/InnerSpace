            ...
            <div class="col-md-3">
                <div class="sidebar">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="home.php"><i class="bi bi-house"></i> Home</a>
                        </li>
                        <li class="nav-item">
                    ...
                    ?>
                        <div class="card">
                            <div class=" card-body mb-2 mt-2">
                                <a href="user_profile.php?user_id=<?php echo $post['user_id']; ?>" class="link link link-offset-2 link-underline link-underline-opacity-0 white">@<?php echo $post['username']; ?></a>
